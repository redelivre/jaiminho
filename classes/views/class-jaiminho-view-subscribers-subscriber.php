...
class Jaiminho_View_Subscribers_Subscriber extends SendPress_View_Subscribers {
...
<?php
	...
	<div class="boxer-inner">
	    ...
	    <strong><?php _e('Saudação','sendpress'); ?></strong>: <input type="text" class="regular-text sp-text" name="salutation" value="<?php echo $sub->salutation; ?>" /><br>
	    ...
	    <strong><?php _e('Profissão','jaiminho'); ?></strong>: <input type="text" class="regular-text sp-text" name="lastname" value="<?php echo $sub->lastname; ?>" /><br>
	    <strong><?php _e('Telefone','jaiminho'); ?></strong>: <input type="text" class="regular-text sp-text" name="phonenumber" value="<?php echo $sub->phonenumber; ?>" /><br>
...
<input type="checkbox" id="delete-this-user" name="delete-this-user" value="yes"/> Selecionando aqui você remove este usuário e assinante e todo o dado relacionado com ele no sistema<br><br>
