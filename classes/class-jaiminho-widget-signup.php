 ...
 * @since 1.0
 */
class Jaiminho_Widget_Signup extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		( strlen($new_instance['job_label']) !== 0 ) ? $instance['job_label'] = strip_tags( $new_instance['job_label'] ) : $instance['job_label'] = 'Profissão';
		...
		( !array_key_exists('show_job',$new_instance) ) ? $instance['show_job'] = false : $instance['show_job'] = $new_instance['show_job'];
	...
	function form( $instance ) {
		...
		<p>
			...
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'job_label' ); ?>" name="<?php echo $this->get_field_name( 'job_label' ); ?>" value="<?php echo $instance['job_label']; ?>" style="width:100%;" />
		</p>
