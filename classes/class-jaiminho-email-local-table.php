 ...
 */
class Jaiminho_Email_Local_Table extends WP_List_Table {
	...
	function column_default($item, $column_name){
		...
		switch($column_name){
			...
			case 'actions':
				...
				$a .= '<a class="btn btn-default" href="'.SendPress_Admin::link('Emails_Tempclone',array('templateID'=>$item->ID)) .'">Clone</a> <a class="btn btn-primary" href="'.SendPress_Admin::link('Emails_Tempstyle',array('templateID'=>$item->ID)) .'">Edit Style</a> <a class="btn btn-primary" href="http://localhost/redelivre/src/wp-admin/admin.php?page=sp-emails&view=templates&templateID='.$item->ID.'">Edit</a>';
				$a .= '</div>';
				return $a;
			break;
		   /* case 'firstname':
